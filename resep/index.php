...
$resep = mysqli_query($conn,"SELECT * FROM rekomendasi_resep");
?>
<!doctype html>
<html>
<head>
...
<body class="bg-gray-200">
	...
	<!--Header-->
	  <section class="bg-no-repeat bg-contain bg-top" style="background-image: url('/website-ikan/images/Header List Produk.png')">
  ...
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
        <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Resep</h1>
    ...
    <div class="flex flex-wrap -m-4">
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <a href="/website-ikan/resep/detailresep.php?id=<?php echo $row['resep_id']; ?>">
          <div class="bg-gray-100 p-6 rounded-lg hover:bg-gray-300">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="<?php echo $row["Gambar"] ;?>" alt="content">
            ...
            <p class="leading-relaxed text-base"><?php echo $row['lama_memasak']; ?></p>
			<p class="leading-relaxed text-base"><?php echo $row['jumlah_porsi']; ?> porsi</p>
          </div>
        </a>
      </div>
      <?php
