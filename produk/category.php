...
$param = $_GET['category'];
$query = mysqli_query($conn,"SELECT * FROM ikan WHERE jenis_ikan = '$param'");
  ...
  <div class="container px-5 py-5 mx-auto">
    ...
    <div class="flex flex-wrap -m-4">
      ...
      <div class="xl:w-1/4 md:w-1/2 p-4">
        <a href="/website-ikan/produk/<?php echo str_replace(' ', '-', $row['nama_ikan']); ?>.php">
          <div class="bg-gray-100 p-6 rounded-lg hover:bg-gray-300">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="<?php echo $row["Url_gambar_ikan_PNG"]; ?>" alt="content">
