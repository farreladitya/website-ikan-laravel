...
$resep = mysqli_query($conn,"SELECT * FROM rekomendasi_resep LIMIT 3");
?>
<!doctype html>
<html>
<head>
...
<body class="bg-gray-200">
	...
	<header class="text-white body-font bg-blue-900">
		<div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
			...
			<nav class="md:ml-auto md:mr-auto flex flex-wrap items-center text-base justify-center">
				<a class="mr-5 hover:text-gray-900 font-bold" href=".">Beranda</a>
	...
	<!--Header-->
	  <section class="bg-no-repeat bg-contain bg-right" style="background-image: url('/website-ikan/images/Header Home.png')">
  ...
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
        <a href="/website-ikan/produk/sepalopoda.php">
...
<section class="text-gray-600 body-font mx-24">
  <div class="container px-5 py-5 mx-auto">
    <div class="flex flex-wrap w-full mb-20">
      <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
        <a href="/website-ikan/produk/demersal.php">
...
<section class="text-gray-600 body-font">
  <div class="container flex flex-wrap px-5 py-12 mx-auto items-center">
    <div class="md:w-1/4 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Rekomendasi Ikan</h1>
      <p class="leading-relaxed text-base">Bingung mau cari ikan yang antimainstream? Yuk cek rekomendasi ikan disini</p>
      <a class="text-indigo-500 inline-flex items-center mt-4">Lihat selengkapnya
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
          <path d="M5 12h14M12 5l7 7-7 7"></path>
        </svg>
      </a>
    </div>
    <div class="flex flex-col md:w-3/4 md:pl-12">
      <div class="flex flex-wrap -m-4">
...
<section class="text-gray-600 body-font">
  <div class="container flex flex-wrap px-5 py-12 mx-auto items-center">
    <div class="md:w-1/4 md:pr-12 md:py-8 md:border-r md:border-b-0 mb-10 md:mb-0 pb-10 border-b border-gray-200">
      <h1 class="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Rekomendasi Resep</h1>
      <p class="leading-relaxed text-base">Bingung mau cari masakan ikan yang anti-mainstream? Yuk cek rekomendasi resep terpopuler disini</p>
      <a class="text-indigo-500 inline-flex items-center mt-4">Lihat selengkapnya
        <svg fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-4 h-4 ml-2" viewBox="0 0 24 24">
          <path d="M5 12h14M12 5l7 7-7 7"></path>
        </svg>
    ...
    <div class="flex flex-wrap -m-4 lg:w-3/4">
      ...
      $i=0;
       while($row = mysqli_fetch_array($resep)) {
      ?>
      <div class="xl:w-1/3 md:w-1/2 p-4">
        <a href="/website-ikan/produk/detailproduk.php?id=<?php
        echo $row['nama_ikan'];?>">
          <div class="bg-gray-100 p-6 rounded-lg hover:bg-gray-300">
            <img class="h-40 rounded w-full object-cover object-center mb-6" src="<?php echo $row["Url"]; ?>" alt="content">
            <h2 class="text-lg text-gray-900 font-medium title-font mb-4"><?php echo ucwords(str_replace(', ', ' ', $row["nama_resep"])); ?></h2>
          </div>
        </a>
      </div>
      <?php
